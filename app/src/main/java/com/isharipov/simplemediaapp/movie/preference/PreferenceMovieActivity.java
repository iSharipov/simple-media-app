 ...
 * 26.06.2018.
 */
public class PreferenceMovieActivity extends DaggerAppCompatActivity {
    ...
    public static void start(Activity activity) {
        Intent intent = new Intent(activity, PreferenceMovieActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_movie_preference);
